...
function uniqueArray(words) {
  return words.filter((item, index, ary) => {
...
// Write a function howManyTimes that will take in an array of words as one argument, and a 
// word to search for as the other.The function will return the number of times that word appears in the array.
